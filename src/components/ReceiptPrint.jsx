...
export default function ReceiptPrint({ booking, receiptId, printedBy, onAfterPrint }) {
  ...
  const receiptContent = (
    <div id="thermal-receipt" style={{
      ...
      {/* Customer Info */}
      <div style={{ marginBottom: "8px" }}>
        <div style={{ fontWeight: "bold", textTransform: "uppercase", marginBottom: "4px", textAlign: "center" }}>Customer Info</div>
      ...
      {/* Booking Details */}
      <div style={{ marginBottom: "8px" }}>
        <div style={{ fontWeight: "bold", textTransform: "uppercase", marginBottom: "4px", textAlign: "center" }}>Booking Details</div>
      ...
      {/* Payment Details */}
      <div style={{ marginBottom: "8px" }}>
        <div style={{ fontWeight: "bold", textTransform: "uppercase", marginBottom: "4px", textAlign: "center" }}>Payment Summary</div>
