...
const TOURNAMENT_SUBLINKS = [
  ...
  { to: "/admin/tournament-v2", label: "Tournaments V2" },
  ...
  return (
    <div className="min-h-screen bg-[#0a0f18]">
        ...
        <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-2 min-h-[52px] sm:min-h-[56px]">
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <div className="hidden xl:flex items-center border-r border-slate-800 pr-4 xl:pr-6">
              {!isOnline ? (
                <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-bold" title="No internet connection">
            ...
            <div className="flex items-center gap-1 sm:gap-3">
              ...
              <div className="flex items-center gap-2 sm:gap-3 pl-2 sm:pl-4 border-l border-slate-800 relative min-w-0">
                ...
                {showLogout && (
                  <div className="absolute top-full right-0 mt-2 w-40 bg-[#151e2d] border border-slate-800 rounded-xl p-2 shadow-lg z-[130]">
                    <NavLink
                      to="/admin/profile"
                    ...
                    <button
                      className="w-full text-left px-3 py-2 text-sm text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition-colors mt-1"
      ...
      <footer className="max-w-[1600px] mx-auto p-4 sm:p-6 mt-8 sm:mt-12 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-500 text-xs font-medium text-center md:text-left">
        <div>© 2026 PICKLE BROS COURT. All rights reserved.</div>
